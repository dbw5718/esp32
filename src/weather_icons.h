...
/*
 * 声明所有天气图标的描述符。
 * 使用 LV_ATTRIBUTE_EXTERN 是一个好习惯，它告诉编译器这些变量是在其他文件中定义的。
 */
...
extern const lv_image_dsc_t Moderate_Snow;
extern const lv_image_dsc_t Light_Cloud;
extern const lv_image_dsc_t Light_Snow;
